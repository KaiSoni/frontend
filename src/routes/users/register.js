        ...
        return (<Layout>
            ...
            <form onSubmit={this.submitForm}>
                ...
                <div className="form-group">
                    ...
                    <input name="name" type="text" onChange={this.updateVal} className="form-control" id="exampleInputName1" aria-describedby="nameHelp" placeholder="Enter name" />
                    <small id="emailHelp" className="form-text text-muted">What do people call you</small>
                </div>
                <div className="form-group">
